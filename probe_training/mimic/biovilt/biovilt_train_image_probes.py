# biovilt_train_image_probes.py
# Trains a single vision-layer demographic probe for BioViL-T.
# This is the BioViL-T equivalent of script5_train_image_probes.py.
#
# Usage:
#   python biovilt_train_image_probes.py --dataset_folder_name MIMIC-CXR-JPG \
#       --layer_name Vis_ResNet_Layer4 --attribute sex
...
def train_single_vision_probe():
    parser = argparse.ArgumentParser(description="Train a single BioViL-T vision-layer probe.")
    ...
    parser.add_argument('--layer_name', type=str, required=True,
                        help="Vision layer to probe (e.g., Vis_ResNet_Layer4).")
    ...
    logging.info(f"{log_prefix} Starting BioViL-T vision probe training.")
