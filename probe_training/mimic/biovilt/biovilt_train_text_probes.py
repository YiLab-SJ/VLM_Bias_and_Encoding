# biovilt_train_text_probes.py
# Trains a single text-layer demographic probe for BioViL-T.
# This is the BioViL-T equivalent of script5_train_text_probes.py.
#
# Usage:
#   python biovilt_train_text_probes.py --dataset_folder_name MIMIC-CXR-JPG \
#       --layer_name Txt_Block_12 --attribute sex
...
def train_single_text_probe():
    parser = argparse.ArgumentParser(description="Train a single BioViL-T text-layer probe.")
    ...
    parser.add_argument('--layer_name', type=str, required=True,
                        help="Text layer to probe (e.g., Txt_Block_12).")
    ...
    logging.info(f"{log_prefix} Starting BioViL-T text probe training.")
