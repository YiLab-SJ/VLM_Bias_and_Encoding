# llavamed_train_text_disease_probe.py
# Trains multi-label disease probes on LLaVA-Med 1.5 text (Mistral) layer embeddings.
# This is the LLaVA-Med 1.5 equivalent of script5_train_text_disease_probe.py.
#
# Usage:
#   python llavamed_train_text_disease_probe.py --dataset_folder_name MIMIC-CXR-JPG \
#       --layer_name Text_BertBlock_11
...
def train_text_disease_probes():
    parser = argparse.ArgumentParser(description="Train LLaVA-Med 1.5 text disease probes for a single layer.")
