# llavamed_train_image_disease_probe.py
# Trains multi-label disease probes on LLaVA-Med 1.5 vision layer embeddings.
# This is the LLaVA-Med 1.5 equivalent of script5_train_image_disease_probe.py.
#
# Usage:
#   python llavamed_train_image_disease_probe.py --dataset_folder_name MIMIC-CXR-JPG \
#       --layer_name Vis_CLIP_Layer_22
...
def train_vision_disease_probes():
    parser = argparse.ArgumentParser(description="Train LLaVA-Med 1.5 vision disease probes for a single layer.")
