# chexagent_train_text_disease_probe.py
# Trains multi-label disease probes on CheXagent text (Phi-2 decoder) layer embeddings.
# This is the CheXagent equivalent of biovilt_train_text_disease_probe.py.
#
# Usage:
#   python chexagent_train_text_disease_probe.py --dataset_folder_name MIMIC-CXR-JPG \
#       --layer_name Txt_PhiBlock_32
...
def train_text_disease_probes():
    parser = argparse.ArgumentParser(description="Train CheXagent text disease probes for a single layer.")
