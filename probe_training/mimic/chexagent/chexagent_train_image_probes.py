# chexagent_train_image_probes.py
# Trains a single vision-layer demographic probe for CheXagent.
# This is the CheXagent equivalent of biovilt_train_image_probes.py.
#
# Usage:
#   python chexagent_train_image_probes.py --dataset_folder_name MIMIC-CXR-JPG \
#       --layer_name Vis_SigLIP_Block_24 --attribute sex
...
def train_single_vision_probe():
    parser = argparse.ArgumentParser(description="Train a single CheXagent vision-layer probe.")
    ...
    parser.add_argument('--layer_name', type=str, required=True,
                        help="Vision layer to probe (e.g., Vis_SigLIP_Block_24).")
    ...
    logging.info(f"{log_prefix} Starting CheXagent vision probe training.")
