#!/bin/bash
# train_medversa_text_probes_pipeline.sh
# Master script to train TEXT probes for MedVersa using universal scripts.
...
# --- MedVersa specific TEXT layers ---
# LLaMA-2-7B architecture: 32 blocks + Embed + FinalNorm
TEXT_LAYERS=("Txt_Embed")

# LLaMA Decoder blocks (32 blocks)
for i in {1..32}; do TEXT_LAYERS+=("Txt_Block_$i"); done
...
LOG_DIR="$SCRIPT_DIR/parallel_logs_training_text_$(date +%Y%m%d_%H%M%S)"
mkdir -p "$LOG_DIR"

echo "======================================================================"
echo "  MedVersa TEXT Probe Training Pipeline - Dataset: $DATASET"
...
echo ""
echo "======================================================================"
echo "  All MedVersa Text Training COMPLETE"
echo "======================================================================"