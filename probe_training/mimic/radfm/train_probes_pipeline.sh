#!/bin/bash
# train_probes_pipeline.sh
# Master script to train all RadFM probes using universal scripts.
...
# --- RadFM specific layers ---
VISION_LAYERS=("Vis_PatchEmbed" "Vis_Block_1" "Vis_Block_2" "Vis_Block_3" "Vis_Block_4" 
               "Vis_Block_5" "Vis_Block_6" "Vis_Block_7" "Vis_Block_8" "Vis_Block_9" 
               "Vis_Block_10" "Vis_Block_11" "Vis_Block_12" "Vis_Perceiver" "Vis_Projected")

TEXT_LAYERS=("Txt_Embed")
for i in {1..40}; do TEXT_LAYERS+=("Txt_Block_$i"); done
...
echo "======================================================================"
echo "  RadFM Probe Training Pipeline (Universal) - Dataset: $DATASET"
...
run_demographic_jobs() {
    ...
    for attribute in "${ATTRIBUTES[@]}"; do
        for layer in "${LAYERS[@]}"; do
            ...
            # Added -u for unbuffered real-time logging
            python -u "$DEMO_PY" \
                --train_dir "$TRAIN_DIR" \
                --val_dir "$VAL_DIR" \
...
# Commented out the vision demographic run since it's already done
...
echo ""
echo "======================================================================"
echo "  All RadFM Training COMPLETE"
echo "======================================================================"