# medgemma_train_image_probes.py
# Trains a single vision-layer demographic probe for MedGemma 1.5.
# Adapted from biovilt_train_image_probes.py with config_medgemma import.
#
# Usage:
#   python medgemma_train_image_probes.py --lodataset_folder_name MIMIC-CXR-JPG \
#       --layer_name Vis_Block_27 --attribute sex
...
def train_single_vision_probe():
    parser = argparse.ArgumentParser(description="Train a single MedGemma 1.5 vision-layer probe.")
    ...
    parser.add_argument('--layer_name', type=str, required=True,
                        help="Vision layer to probe (e.g., Vis_Block_27).")
    ...
    logging.info(f"{log_prefix} Starting MedGemma 1.5 vision probe training.")
