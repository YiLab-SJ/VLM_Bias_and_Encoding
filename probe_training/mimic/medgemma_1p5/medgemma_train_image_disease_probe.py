# medgemma_train_image_disease_probe.py
# Trains multi-label disease probes on MedGemma 1.5 vision layer embeddings.
# Adapted from biovilt_train_image_disease_probe.py with config_medgemma import.
#
# Usage:
#   python medgemma_train_image_disease_probe.py --dataset_folder_name MIMIC-CXR-JPG \
#       --layer_name Vis_Block_27
...
def train_vision_disease_probes():
    parser = argparse.ArgumentParser(description="Train MedGemma 1.5 vision disease probes for a single layer.")
